  ...
  const sidebar = (
    <div className="flex flex-col h-full bg-[#040c1a] border-r border-[#0d1b35]">
      ...
      <div className="h-14 flex items-center px-5 border-b border-[#0d1b35] shrink-0">
        <div className="w-6 h-6 bg-[#D4AF37] rounded-sm flex items-center justify-center mr-3 shrink-0">
          <span className="text-[#030810] font-mono font-black text-xs">D</span>
        </div>
      ...
      <div className="md:hidden flex items-center justify-between px-4 h-12 bg-[#040c1a] border-b border-[#0d1b35] shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 bg-[#D4AF37] rounded-sm flex items-center justify-center">
            <span className="text-[#030810] font-mono font-black text-[10px]">D</span>
          </div>
