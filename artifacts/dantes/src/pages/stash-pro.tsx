...
const CATALOG: Record<string, Product[]> = {
  ...
  "Grinders": [
    ...
    { title: "Zinc Herb Grinder — Small", desc: "A compact 3-layer zinc alloy grinder from the country series, finished in Australian flag colours. Sharp teeth grind evenly, the mesh screen and catcher chamber collect the fines, and the magnetic lid keeps it secure in your pocket.", bullets: ["Compact 3-layer zinc alloy build", "Australian flag country series", "Mesh screen with catcher chamber and scraper", "Magnetic lid, pocket-friendly"], img: "/grinder-au.png", handle: "stash-pro-zinc-herb-grinder-small" },
  ...
  "Rolling Trays": [
    ...
    { title: "Wooden Rolling Tray", desc: "A natural wood rolling tray with a warm finish and smooth surface. Raised edges keep your essentials in place, and the wood build gives it a premium, tactile feel that stands apart from standard metal trays.", bullets: ["Natural wood construction", "Smooth surface with raised edges", "Premium tactile feel", "Easy to wipe clean"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/WOODS3_0.75x.png?v=1762860827", handle: "stash-pro-wooden-rolling-tray" },
  ...
  "Pre-Rolled Cones": [
    ...
    { title: "Brown Pre-Rolled Cones — King Size Pack of 6", desc: "King size ready-to-fill cones in unbleached brown paper. Larger format for those who prefer a more generous fill — same clean, consistent shape every time.", bullets: ["King size format", "Pack of 6", "Unbleached brown paper", "Ready-to-fill"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/cone_1.3.png?v=1762857834", handle: "pre-rolled-cones-brown-king-size-pack-of-6" },
    ...
    { title: "Pink Pre-Rolled Cones — Burning Desire", desc: "Ready-to-fill pink cones from the Burning Desire collection. Same easy, no-roll format — just fill, pack and twist. The bold pink colour makes them stand out from the standard.", bullets: ["Burning Desire pink format", "Ready-to-fill design", "No rolling required", "Bold visual appeal"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/pinkcone1_24b23916-8046-4836-a591-e9bbfde172c0.png?v=1762858283", handle: "pre-rolled-cones-pink" },
  ],
  "Sheesha & Hookah": [
