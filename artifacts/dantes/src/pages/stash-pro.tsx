...
const CATALOG: Record<string, Product[]> = {
  "Lighters": [
    ...
    { title: "Flex-E Flexible Lighter", desc: "A flexible-neck utility lighter with a long reach, designed for candles, fireplaces and hard-to-reach spots. The bendable neck keeps your hand clear of the flame while delivering reliable ignition every time.", bullets: ["Flexible neck for hard-to-reach spots", "Long reach design", "Reliable ignition", "Refillable"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/FLEX3.png?v=1762935853", handle: "stash-pro-flex-e-flexible-lighter" },
    { title: "Fold-E Foldable Lighter", desc: "A foldable lighter that collapses flat for ultra-compact storage. Open it up and you have a full-sized flame — fold it back and it disappears into any pocket or pouch.", bullets: ["Folds flat for compact storage", "Full-sized flame when open", "Pocket and pouch friendly", "Refillable"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/fold3.png?v=1762935965", handle: "stash-pro-fold-e-foldable-lighter" },
    { title: "Jetty Windproof Lighter", desc: "A compact windproof jet flame lighter built for outdoor reliability. The focused jet flame resists wind effectively, delivering consistent ignition wherever you are.", bullets: ["Windproof jet flame", "Compact metal body", "Consistent outdoor ignition", "Refillable"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/jetty2.png?v=1762936176", handle: "stash-pro-jetty-windproof-lighter" },
    { title: "Premium Refillable Lighter", desc: "A premium refillable lighter with a polished metal body and smooth ignition. Designed for users who want a dependable everyday lighter with a refined look and feel.", bullets: ["Premium polished metal body", "Smooth, reliable ignition", "Refillable for repeated use", "Adjustable flame"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/L_IFGBTTRETRTRASGFDAJHFBASDA-copy-2_0007s_0001_Layer-87.png?v=1763461090", handle: "stash-pro-premium-refillable-lighter" },
    { title: "Flippy S4 Jet Flame Lighter", desc: "A compact jet flame lighter with a satisfying flip-top action. The focused flame is windproof and delivers precise ignition, while the sleek form factor fits naturally in hand or pocket.", bullets: ["Jet flame — windproof and precise", "Satisfying flip-top action", "Compact, ergonomic form", "Refillable"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/L_IFGBTTRETRTRASGFDAJHFBASDA-copy-2_0006s_0001_Layer-61.png?v=1763461247", handle: "stash-pro-flippy-s4-jet-flame-lighter" },
  ],
  "Grinders": [
    ...
    { title: "Pink Grinder — Large", desc: "A full-size 4-part metal grinder in a bold pink finish. Sharp teeth deliver an even grind, with a mesh screen and deep catcher chamber keeping the fines collected. A magnetic lid keeps everything secure.", bullets: ["Large 4-part metal build", "Bold pink finish", "Mesh screen with deep catcher chamber", "Magnetic lid"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/pink1.png?v=1762937003", handle: "stash-pro-pink-grinder-large" },
  ],
  "Ashtrays": [
  ...
  "Rolling Papers & Tips": [
    ...
    { title: "Ripper Tipper White — Papers with Filter Tips", desc: "A compact rolling paper booklet that brings papers and filter tips together in one easy-to-carry format. Includes white rolling papers and perforated filter tips for convenient everyday preparation.", bullets: ["Papers and tips in one booklet", "Perforated filter tips included", "Compact, pocket-friendly format", "Natural gum seal"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/rippertipper_white_0.75x.png?v=1762929519", handle: "stash-pro-white-ripper-tipper" },
  ...
  "Pre-Rolled Cones": [
    { title: "Brown Pre-Rolled Cones — Pack of 5", desc: "No Roll, No Problem. A shortcut to a perfect roll, every time. These empty pre-rolled brown paper cones are ideal for quick setups and consistent results. Just fill, pack, and you are ready.", bullets: ["Pack of 5 pre-rolled cones", "Made from unbleached brown rolling paper", "Ready-to-fill — no rolling skills needed", "Consistent shape every time"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/SP_CONES_BROWN_PACK_OF_5_0.75x.png?v=1762857211", handle: "brown-pre-rolled-cones-5-pack" },
    { title: "Brown Pre-Rolled Cones — Pack of 6", desc: "A ready-to-fill pack of 6 unbleached brown cones for quick, consistent preparation. Just fill, pack and you are set — no rolling required.", bullets: ["Pack of 6 pre-rolled cones", "Unbleached brown paper", "Ready-to-fill format", "Consistent shape"], img: "https://cdn.shopify.com/s/files/1/0674/4159/0448/files/brownconePACKOF6.png?v=1762857059", handle: "brown-6-cones-84-mm" },
