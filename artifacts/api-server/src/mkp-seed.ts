...
const DEALS = [
  ...
  { title: "Samsung 65\" QLED 4K TV", description: "Quantum Dot display, 120Hz, smart hub", platform: "shopee", originalPrice: "39900", salePrice: "27900", discountPercent: "30.08", category: "Electronics", url: "https://shopee.co.th", isTrending: true, isVerified: true },
  { title: "Apple Watch Series 9 GPS 41mm", description: "Carbon neutral, S9 chip, always-on retina", platform: "lazada", originalPrice: "14900", salePrice: "11490", discountPercent: "22.89", category: "Smartwatches", url: "https://lazada.co.th", isTrending: true, isVerified: true },
  { title: "JBL Flip 6 Portable Speaker", description: "IP67 waterproof, 12hr battery, PartyBoost", platform: "tiktok", originalPrice: "3990", salePrice: "2390", discountPercent: "40.10", category: "Speakers", url: "https://tiktokshop.com", isTrending: true, isVerified: true },
  { title: "GoPro Hero 12 Black", description: "5.3K video, HyperSmooth 6.0, 27MP photo", platform: "shopee", originalPrice: "15990", salePrice: "10990", discountPercent: "31.27", category: "Cameras", url: "https://shopee.co.th", isTrending: false, isVerified: true },
  { title: "Xiaomi Smart Air Purifier 4 Pro", description: "OLED display, HEPA filter, app control, 60m²", platform: "tiktok", originalPrice: "4990", salePrice: "2890", discountPercent: "42.08", category: "Smart Home", url: "https://tiktokshop.com", isTrending: true, isVerified: true },
  { title: "New Balance 574 Classic", description: "Iconic suede & mesh, cushioned ENCAP midsole", platform: "lazada", originalPrice: "3490", salePrice: "1990", discountPercent: "42.98", category: "Footwear", url: "https://lazada.co.th", isTrending: false, isVerified: true },
  { title: "SK-II Facial Treatment Essence 230ml", description: "Pitera essence, 90-day radiance programme", platform: "shopee", originalPrice: "7900", salePrice: "5490", discountPercent: "30.51", category: "Beauty", url: "https://shopee.co.th", isTrending: true, isVerified: true },
  { title: "Keychron K2 Pro Mechanical Keyboard", description: "75% layout, hot-swappable, Bluetooth 5.1", platform: "lazada", originalPrice: "3490", salePrice: "2290", discountPercent: "34.38", category: "Peripherals", url: "https://lazada.co.th", isTrending: false, isVerified: true },
];
